...
public class FileUtils extends org.apache.commons.io.FileUtils {
	 ...
	 * @call {@linkplain FileUtils this}{@linkplain FileUtils#deleteFile(String)
	 *       deleteFile}
	 * @call {@linkplain FileUtils this}
	 *       {@linkplain FileUtils#deleteDirectory(String) deleteDirectory}
	 * @version 1.0
	 * @param dirName
	 *            被删除的目录所在的文件路径
	 ...
	 * @call {@linkplain FileUtils this}
	 *       {@linkplain FileUtils#zipFilesToZipFile(String, File, ZipOutputStream)
	 *       zipFilesToZipFile}
	 * @call {@linkplain FileUtils this}
	 *       {@linkplain FileUtils#zipDirectoryToZipFile(String, File, ZipOutputStream)
	...
	/**
	 * @description 传入url地址 若url地址为空，返回空字符串 若非空，获得相对于主机的绝对路径
	 * @version 1.0
	 * @param urlPath
	 * @return
	 */
	public static String getAbsolutePath(String urlPath) {
		if (StringUtils.isBlank(urlPath)) {
			...
			return PathKit.getRootClassPath() + urlPath.substring(urlPath.indexOf("/", 1), urlPath.length());
		}
	}
	 ...
	 *              若出现异常，则捕获并打印异常
	 * @call {@linkplain FileUtils this}{@linkplain FileUtils#createFile(String)
	 *       createFile}
	 * @version 1.0
	 * @param content
	 * @param filePath
