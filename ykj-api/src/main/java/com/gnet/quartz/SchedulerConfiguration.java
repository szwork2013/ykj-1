...
import com.gnet.quartz.job.SampleJob;
import com.gnet.quartz.spring.AutowiringSpringBeanJobFactory;

@Configuration
@ConditionalOnProperty(name = "quartz.enable")
